...
{
    int verbose = 1;  //int verbose = 1 or 2 to print;          /* Verbosity level */
    ...
    // printf("Init MPI good\n");

    if (nprocs!=2) {
        printf("please run this with 2 processors to ensure correct 1D domain decomposition\n");
        MPI_Finalize();
        exit(1);
    }
